...
type MapMarkerProps = {
  ...
  /** Anchor position of the marker (default: "bottom") */
  anchor?: MarkerOptions["anchor"];
} & Omit<MarkerOptions, "element" | "anchor">;
...
function DefaultMarkerIcon() {
  return (
    <div className="relative flex flex-col items-center">
      <MapPin className="size-6 text-primary fill-background drop-shadow-md" />
      <div className="bg-primary/20 absolute -bottom-1 h-1 w-2 rounded-full blur-[1px]" />
    </div>
  );
}
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-border bg-background text-foreground [&>button:not(:last-child)]:border-border flex flex-col overflow-hidden rounded-md border shadow-sm [&>button:not(:last-child)]:border-b">
      {children}
    </div>
  );
}
