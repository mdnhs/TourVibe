...
const cardAccents = [
  { bar: "from-amber-400 to-orange-500", glow: "bg-amber-400/15", avatar: "bg-amber-400/20 text-amber-300" },
  { bar: "from-cyan-400 to-sky-500",     glow: "bg-cyan-400/15",  avatar: "bg-cyan-400/20 text-cyan-300" },
  { bar: "from-emerald-400 to-teal-500", glow: "bg-emerald-400/15", avatar: "bg-emerald-400/20 text-emerald-300" },
  { bar: "from-violet-400 to-purple-500", glow: "bg-violet-400/15", avatar: "bg-violet-400/20 text-violet-300" },
  { bar: "from-rose-400 to-pink-500",    glow: "bg-rose-400/15",  avatar: "bg-rose-400/20 text-rose-300" },
  { bar: "from-fuchsia-400 to-violet-500", glow: "bg-fuchsia-400/15", avatar: "bg-fuchsia-400/20 text-fuchsia-300" },
];
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-4">
            ...
            >
              Social proof for your{" "}
              <span className="relative inline-block">
                <span className="relative z-10">car-tour</span>
                <span
          ...
          >
            ...
            <div>
              <p className="font-heading text-lg font-bold leading-none text-white">4.9</p>
              <p className="mt-0.5 text-[10px] font-semibold uppercase tracking-widest text-white/35">Avg. Rating</p>
            </div>
          </div>
        </div>
            ...
            return (
              <div
                ...
                className="group animate-in fade-in slide-in-from-bottom-4 duration-500
                           relative overflow-hidden rounded-[2rem] border border-white/8 bg-white/5
              ...
              >
                ...
                <div className="space-y-5 p-6">
                  {/* Quote icon */}
                  <Quote className="size-7 opacity-20 text-white" />
