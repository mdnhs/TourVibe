        ...
        <Carousel opts={{ align: "start" }}>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="space-y-2 sm:space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50 px-3 py-1 sm:px-4 sm:py-1.5 text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-amber-700 animate-in fade-in slide-in-from-left-4 duration-500">
                <span className="relative flex size-1 sm:size-1.5">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-amber-400 opacity-75" />
                  <span className="relative inline-flex size-1 sm:size-1.5 rounded-full bg-amber-600" />
                </span>
                Latest Stories
              </div>
              ...
              >
                ...
                <span className="relative inline-block">
                  ...
                  <span className="absolute -bottom-0.5 left-0 h-0.5 sm:-bottom-1 sm:h-1 w-full rounded-full bg-gradient-to-r from-indigo-400/50 to-violet-400/50" aria-hidden="true" />
                </span>
              </h2>

              <p
                className="max-w-md text-xs sm:text-sm leading-relaxed sm:leading-7 text-slate-500 animate-in fade-in duration-500"
                style={{ animationDelay: "140ms" }}
              >
                Travel tips, destination guides and insider stories.
              </p>
            </div>
          ...
          {posts.length === 0 ? (
            ...
            <CarouselContent className="mt-12 -ml-6">
              {posts.map((post, i) => {
                ...
                return (
                  ...
                  >
                    <article
                      ...
                      className="group animate-in fade-in slide-in-from-bottom-4 duration-500 relative flex h-full flex-col overflow-hidden rounded-[1.5rem] border border-slate-200/80 bg-white shadow-lg shadow-slate-200/60 transition-all hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-slate-300/50"
                    >
                      {/* Hover glow */}
