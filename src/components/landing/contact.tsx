import { Mail, Phone, Headset, Rocket, ArrowRight } from "lucide-react";

const contactItems = [
  {
    icon: Mail,
    label: "Email",
    value: "hello@tourvibe.demo",
    ...
    <section id="contact" className="relative overflow-hidden px-4 py-24 sm:px-6">
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          {/* ── LEFT: CTA card ── */}
          <div
            className="relative overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white p-8 shadow-lg shadow-slate-200/50
          ...
          >
            ...
            <h2 className="mt-6 font-heading text-3xl font-extrabold leading-tight tracking-tight text-slate-950 sm:text-4xl">
              ...
              <span className="relative inline-block">
                <span className="relative z-10">tour brand</span>
                <span
                  ...
                  {contactItems.map((item, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="mt-1 text-sm font-semibold text-slate-950 leading-snug">
                          {item.value}
                        </p>
                      </div>
                    );
